...
recipes = "../dataset/recipes.csv"
dataset = pd.read_csv(recipes, sep=';')
'''print(dataset.head())
...
# elimino colonna con valori nulli
columns_to_drop = ['primary_temp']
...
# sostituisco nella colonna categoria il nome India Pale Ale (IPA) con IPA in quanto rappresentano la stessa categoria
dataset['category'] = dataset['category'].replace('India Pale Ale (IPA)', 'IPA')

# NOTA: in category abbiamo anche valori NO PROFILE SELECTED ------
...
dataset.to_csv("../dataset_cleaned/recipes_dataset_cleaned.csv", index=False)